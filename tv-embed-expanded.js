!function() {
    "use strict";
    var t="/static/bundles/", e="https: //s3.tradingview.com/", i= {
    events: "external-embedding/embed-widget-events.js", hotlists:"external-embedding/embed-widget-hotlists.js", marketoverview:"external-embedding/embed-widget-market-overview.js", tickers:"external-embedding/embed-widget-tickers.js", forex_cross_rates:"external-embedding/embed-widget-forex-cross-rates.js", market_quotes:"external-embedding/embed-widget-market-quotes.js", forex_heat_map:"external-embedding/embed-widget-forex-heat-map.js", screener:"external-embedding/embed-widget-screener.js"}
;
    var r=function(e, i) {
    var r=this;
...
, n.utmInfo.get=function() {
    return {
    utm_source: location.hostname, utm_medium:"widget", utm_campaign:this.widgetName;
}
}, r.prototype._environment=function() {
    var t="www.tradingview.com"===location.host||"wwwcn.tradingview.com"===location.host||"dwq4do82y8xi7.cloudfront.net"===location.host||"s.tradingview.com"===location.host||"i18n.tradingview.com"===location.host||"partial.tradingview.com"===location.host||location.host.match(/^[a-z] {
    2;
}
\.tradingview\.com/)||location.host.match(/prod-[^.]+.tradingview.com/)?"battle": -1!==location.href.indexOf("tradingview.com")?"staging":location.host.match(/webcharts/)?"staging_local":(location.host.match(/^localhost(:\d+)?$/), "local");
    return"local"===t&&null===location.host.match(/^localhost(: \d+)?$/)&&(t="battle"), t;
}
, r.prototype.filterRawSettings=function(t) {
    var e=this.propertiesToSkipInHash.concat(this.propertiesToWorkWith), i= {
}
;
...
, r.prototype._findScripts=function() {
    var t, e=document.getElementsByTagName("script"), i=[], r=null;
    for(t=e.length;
    t--;
    ) {
    var n=e[t].src;
    ...
    var o=("/"===r.pathname[0]?"": "/")+r.pathname, s=r.host===this.cloudfrontHost||"d33t3vvu2t2yu5.cloudfront.net"===r.host;
    o!==this.pathname||"battle"===this._environment()&&!s||i.push(e[t]);
}
}return i;
}, r.prototype._replaceScript=function(t) {
    var e, i, r;
    if(this.script=t, "json"===this.settingsFormat?e=this._scriptContentToJSON(): "stroke"===this.settingsFormat&&(e=t.innerHTML.trim()), e)if(this.settings=this.filterRawSettings(e), i=this.settings, r=this.utmInfo, Object.keys(r).forEach(function(t) {
    i[t]=r[t];
}
), this._isValidSettings()) {
    var n, o=isNaN(this.settings.height)?this.settings.height: this.settings.height+"px", s=isNaN(this.settings.width)?this.settings.width:this.settings.width+"px";
...
\n\t", n));
    var a=this._extractOldStyleEmbedCopyrightFromDOM(), c=a&&!this.settings.whitelabel, h=a||this.iframeContainer.querySelector(".tradingview-widget-copyright")?"calc("+o+" - 32px)": o;
    this.iframe=this._createIframe(h, s, t.id);
    ...
    p.style.height="32px", p.style.lineHeight="32px", p.style.width=s, p.style.textAlign="center", p.style.verticalAlign="middle", p.innerHTML=a.innerHTML, this.iframeContainer.appendChild(p);
}
...
, r.prototype._buildGetQueryString=function() {
    var t=this, e=this.propertiesToGetParams.filter(function(e) {
    return t.settings[e];
}
).map(function(e) {
    ...
    return e?"?"+e: ""}
, r.prototype._buildHashString=function() {
    var t=this, e= {
}
;
    return Object.keys(this.settings).forEach(function(i) {
    -1===t.propertiesToSkipInHash.indexOf(i)&&(e[i]=t.settings[i]);
}
), Object.keys(e).length>0?"#"+encodeURIComponent(JSON.stringify(e)): ""}, r.prototype._scriptContentToJSON=function() {
    ...
    var n=this.iframeSrcBase+this._buildGetQueryString()+this._buildHashString();
...
, i.propertiesToWorkWith.get=function() {
    return["showToolbar", "defaultColumn", "defaultScreen", "market", "largeChartUrl", "locale", "width", "height", "customer", "screener_type", "displayCurrency", "whitelabel"];
}
, i.propertiesToSkipInHash.get=function() {
    return this.settings&&this.settings.screener_type&&"crypto_mkt"===this.settings.screener_type?["customer"]: [];
}
, e.prototype.filterRawSettings=function(e) {
    var i=t.prototype.filterRawSettings.call(this, e);
    return"crypto_mkt"===i.screener_type&&(i.market="crypto"), i.enableScrolling=!0, i;
}
